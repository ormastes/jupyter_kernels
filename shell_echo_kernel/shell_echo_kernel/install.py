...
kernel_json = {
    "argv": [sys.executable, "-m", "shell_echo_kernel", "-f", "{connection_file}"],
    "display_name": "Shell Echo",
    "language": "text",
}
...
def install_my_kernel_spec(user=True, prefix=None):
    with TemporaryDirectory() as td:
        ...
        KernelSpecManager().install_kernel_spec(td, 'shell_echo', user=user, prefix=prefix)
